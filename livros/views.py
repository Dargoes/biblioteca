...
def livros_add(request):
    ...
    return render(request, 'livros.html', {'autores': autores, 'generos': generos, 'editoras': editoras})
...
def livros_edit(request, id):
    ...
    generos = query("SELECT * FROM Generos")
    editoras = query("SELECT * FROM Editoras")
    return render(request, 'livros_edit.html', {'livro': livro, 'autores': autores, 'generos': generos, 'editoras': editoras})
